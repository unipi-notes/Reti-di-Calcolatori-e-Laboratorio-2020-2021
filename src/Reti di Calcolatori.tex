...
\begin{figure}[!h]
	...
	\caption{Un esempio di WAN a cavo condiviso e a commutazione.\newline
		Queste WAN permettono l'esistenza di \textbf{percorsi alternativi} e la \textbf{divisione del traffico}. Una \textbf{WAN punto punto} ha \textbf{solo} 2 punti di terminazione.}
\end{figure}
